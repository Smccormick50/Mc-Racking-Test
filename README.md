...
- **Recovery** — restore the 10 most recent deletions. Older ones aren't shown but stay in Firestore. Restoring an invoice re-deducts inventory and refuses if stock isn't available.
- **Export** — one-click download of the live inventory or all invoices as an Excel `.xlsx` file. Opens in Excel, Google Sheets, or Numbers.
